...
export const couple = {
  groom: "Dipesh Dixit",
  bride: "Poonam Dhekekar",
};

export const weddingInfo = {
  title: "The Wedding",
  subtitle: "Two hearts, one promise, a lifetime of togetherness.",
  copy:
    "Join us as Dipesh Dixit and Poonam Dhekekar begin a beautiful forever.",
  date: "20th April 2026",
  time: "11:00 AM onwards",
  timeNote: "(Baraat & Shaadi)",
  venue: "GCC Club",
  venueLines: [
  ...
  mapUrl:
    "https://www.google.com/maps/search/?api=1&query=GCC+Club+Mira+Road",
};
